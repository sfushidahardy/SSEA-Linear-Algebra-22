...
Syllabus and lesson plans are also provided. The syllabus outlines expectations for students and instructors, and overall administrative details about the course. The lesson plans describe, in detail, each lesson carried out throughout the course---in particular, how the activities are spaced through the four weeks.
> [Syllabus](https://github.com/sfushidahardy/SSEA-Linear-Algebra-Activities/blob/main/Syllabus/Syllabus)
>
> [Lesson Plans](https://github.com/sfushidahardy/SSEA-Linear-Algebra-Activities/blob/main/Syllabus/LessonPlans)
